...
| 3 | FDD + diagramas | Escrito a partir dos ADRs + deep-dives de código (contratos, matriz `WEBHOOK_*`, integração com 8 arquivos reais). [`docs/FDD.md`](./docs/FDD.md). Diagramas C4/Mermaid via `diagrams-generator`. |
| 4 | PRD | _(pendente)_ |
